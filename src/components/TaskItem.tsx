...
interface TasksItemProps {
    ...
    removeTask: (id: number) => void; //usar () => removeTask(item.id)
    editTask: ({taskId, taksNewTitle}: EditTaskArgs)=> void;
  }
...
export function TaskItem({task, editTask, removeTask, toggleTaskDone}: TasksItemProps){
    ...
    function handleSubmitEditing(){
        editTask({taskId: task.id, taksNewTitle: taskNewTitleValue});
        setIsEditing(false);
    }
